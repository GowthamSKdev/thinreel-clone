...
import Indoor_video from "../assets/video/wisecrack_v1.mp4";
import Outdoor_video from "../assets/video/wisecrack_v2.mp4";
...
const ContentSection = () => {
  ...
  return (
    <section className="bg-background content-section container mx-auto px-4 flex flex-col justify-between items-center mt-40 lg:mt-56">
      ...
      <p className="font-BebasNeue text-pretty max-w-[380px] text-center  text-neutral-500 sm:hidden">
        You’re constantly pushed to deliver more, faster and better. But
        production can leave you with headaches, from unclear costs and missed
        deadlines to creative clashes.
      </p>

      <div className="h-80 flex gap-4 justify-center items-center">
        <div className="h-[250px] sm:h-[300px] xl:h-[350px] w-[170px] lg:w-[250px] -rotate-12 overflow-hidden rounded-xl shadow-lg ">
        ...
        <div className="h-[250px] sm:h-[300px]  xl:h-[350px] rotate-12 w-[170px] lg:w-[250px] overflow-hidden rounded-xl shadow-lg ">
          <video
            autoPlay
            playsInline
            muted
      ...
      <p className="font-BebasNeue text-pretty max-w-[380px] text-center  text-neutral-500 sm:hidden">
        We work alongside agencies that need incredible content without the
        dramas. With crew, kit and post in-house, we help you get to great
        outcomes faster by working leaner.
      </p>
      <video autoPlay playsInline muted loop className="h-1/4 visible w-full">
        <source
