  ...
  return (
    <>
      <section className="WalkerAgency-section py-40 pt-80">
        <h2 className="WalkerAgency-text text-3xl sm:text-7xl md:text-8xl xl:text-9xl font-BebasNeue text-center">
          “we've amassed some <br /> incredible pieces of creative <br /> that
          everyone's proud of”
        </h2>
      ...
      <section className="ZennenThomas-section container mx-auto px-4 py-20 flex flex-col items-center xl:items-end xl:flex-row gap-10 w-full ">
        ...
        <div className=" font-BebasNeue text-base sm:text-xl lg:w-1/2">
          <h2 className="ZennenThomas-text font-BebasNeue text-4xl sm:text-6xl lg:text-8xl tracking-tighter">
            The right people, <br /> right there with you.
          </h2>
          <p className="mt-6">
            Of course we’re obsessed with brand storytelling and visual
            narratives. These are table stakes for any creative production
            company.
          </p>
          <p className="mt-6">
            But in the chaos of a client project, you need friendly people you
            can bounce ideas off. Problem solvers who go further to find a great
            angle on your ideas. And a team that takes the weight off because
            you trust they’ll get it done, and done with style.
          </p>
        </div>
      </section>
    </>
