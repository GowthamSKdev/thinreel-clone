    ...
    return (
        <>
            <section className="WalkerAgency-section py-40 pt-80">
                <h2 className="WalkerAgency-text text-3xl sm:text-7xl md:text-8xl xl:text-9xl font-BebasNeue text-center">“we've amassed some <br /> incredible pieces of creative <br /> that everyone's proud of”</h2>
            ...
            <section className="ZennenThomas-section container mx-auto px-4 py-20 flex flex-col items-end lg:flex-row gap-10 ">
                <div className="lg:w-3/4 h-[50vh] lg:h-screen w-full overflow-hidden relative">
                    ...
                    h-[150%] object-bottom object-cover" loading="lazy" src={Team_image} alt="" />
                </div>
                <div className=" font-BebasNeue text-base sm:text-xl lg:w-1/2">
                    <h2 className="ZennenThomas-text font-BebasNeue text-4xl sm:text-6xl lg:text-8xl tracking-tighter">The right people, <br /> right there with you.</h2>
