...
const Projects = [
  ...
  },
  {
    type: "The Rise",
    title: "Give Life",
    tags: ["Job Fare", "Training"],
    image: theRise,
  },
  {
    type: "Sri Mahalakshmi silks",
    title: "Textile",
    tags: ["Kanchipuram silks", "lifeStyle"],
    image: sriMahalakshmi_video,
  },
...
const ProjectSection = () => {
  ...
  return (
    <section className="project-section pt-40" id="work">
      ...
      <div className="mt-20">
        {Projects.map((project, index) => (
          ...
          >
            ...
            <video
              data-speed="auto"
              className="absolute inset-0 w-full h-[160%] object-cover object-center -z-0"
              loop
              muted
              autoPlay
            >
            ...
            <div className="container mx-auto font-BebasNeue z-10 w-full flex flex-col lg:flex-row justify-center lg:justify-between items-center px-4 py-2 hover:bg-background hover:text-accent">
              <h2 className="text-7xl lg:text-5xl text-center">
                {project.type}
              </h2>
              <p className="text-xl italic">{project.title}</p>
              <p className="hidden lg:flex space-x-1">
                {project.tags.map((t, i) => (
                  <span
                    key={i}
                    className="p-2 border border-dashed border-slate-300 bg-slate-800/20"
                  >
                    {t}
                  </span>
                ))}
